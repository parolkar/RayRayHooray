...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 6.0.0".freeze, "< 8.1".freeze])
  s.add_development_dependency(%q<appraisal>.freeze, ["~> 2.5.0".freeze])
  s.add_development_dependency(%q<railties>.freeze, [">= 3.2.0".freeze, "< 8.1".freeze])
  ...
  s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.26.0".freeze])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.6.0".freeze])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.0.1".freeze])
